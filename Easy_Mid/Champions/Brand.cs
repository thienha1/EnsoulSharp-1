...
namespace EasyMid.Champions
{
    class Brand
    {
        ...
        public static void OnLoad()
        {
            ...
            q.SetSkillshot(0.25f, 60, 1550, true, false, SkillshotType.Line);
            w.SetSkillshot(1, 250, float.MaxValue, false, false, SkillshotType.Circle);
